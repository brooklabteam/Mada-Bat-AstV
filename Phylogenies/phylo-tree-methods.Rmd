...
did 500 trees-- took about 3 hours.
** I did get a best tree, so the ML finished.

5. did it converge?
`raxml-ng-mpi --bsconverge --bs-trees T3.raxml.bootstraps --prefix T4 --seed 2 --threads 7`
